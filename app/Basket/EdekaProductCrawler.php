...
class EdekaProductCrawler
{
    ...
    public function getProductsName(){
        ...
        $apiName = 'artikelbezeichnung_tlc';

        $result = $this->getApiResults();
        $result = $result->response->docs;

        foreach ($result as $key => $elememt) {
            $this->name[] = $elememt->$apiName;
        }
    ...
    public function getDescription(){
        $apiName = 'auslobungen_tlcm';
        $result = $this->getApiResults();
        $result = $result->response->docs;
        foreach ($result as $key => $elememt) {
            $description = implode(" ", $elememt->$apiName);
